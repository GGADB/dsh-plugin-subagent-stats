	...
	factory: (require) => {
		...
		*/
		...
		const BUBBLE = {
			...
			// The fill is a softened dark gray (lighter than tooltip-bg).
		...
		// Distinct title colors: a brighter brand blue for the main session and
		// a brighter violet for sub-agents — readable on the softened bubble.
		const TT_TITLE_ROOT = "#8ab4ff";
		const TT_TITLE_CHILDREN = "#bca4ff";
